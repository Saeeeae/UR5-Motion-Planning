...
int main(int argc, char** argv)
{
  ...
  static const std::string PLANNING_GROUP = "ur5_robot";
  ...
  namespace rvrt = rviz_visual_tools;
  ...
  vector<vector<double>>tmp = getVT();
  std::vector<double> joint_group_positions = tmp[1];
